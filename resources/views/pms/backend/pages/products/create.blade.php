                        ...
                        <form action="{{ route('pms.product-management.product.store') }}" method="post"
                            ...
                            <div class="form-row">
                                <div class="col-md-2">
                                    <p class="mb-1 font-weight-bold"><label for="sku"><strong>
                                            ...
                                            </strong></label> {!! $errors->has('sku')? '<span class="text-danger text-capitalize">'. $errors->first('sku').'</span>':'' !!}
                                    </p>
                                    <div class="input-group input-group-md mb-3 d-">
                                        <input type="text" name="sku" id="sku" class="form-control rounded"
                                               aria-label="Large" placeholder="{{__('Item Code')}}"
                                               aria-describedby="inputGroup-sizing-sm" required
                                               value="{{ old('sku')?old('sku'):$sku }}"
                                               data-sku="{{ old('sku')?old('sku'):$sku }}">
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <p class="mb-1 font-weight-bold"><label for="name"><strong>{{ __('Name') }}<span
                                                        class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('name')? '<span class="text-danger text-capitalize">'. $errors->first('name').'</span>':'' !!}
                                    </p>
                                    <div class="input-group input-group-md mb-3 d-">
                                        <input type="text" name="name" id="name" class="form-control rounded"
                                               aria-label="Large" placeholder="{{__('Item Name')}}"
                                               aria-describedby="inputGroup-sizing-sm" required
                                               value="{{ old('name') }}">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <p class="mb-1 font-weight-bold"><label for="product_type"><strong>Product Type<span
                                                        class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('product_type')? '<span class="text-danger text-capitalize">'. $errors->first('product_type').'</span>':'' !!}
                                    </p>
                                    <div class="select-search-group input-group input-group-md mb-3 d-"
                                         onchange="getSubCategories()">
                                        <select name="product_type" id="product_type"
                                                class="form-control parent-category">
                                ...
                                <div class="col-md-4">
                                    <p class="mb-1 font-weight-bold"><label for="category_id"><strong>Sub Category<span
                                                        class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('category_id')? '<span class="text-danger text-capitalize">'. $errors->first('category_id').'</span>':'' !!}
                                    </p>
                                    <div class="select-search-group input-group input-group-md mb-3 d-">
                                        <select name="category_id" id="category_id"
                                                class="form-control rounded select2 sub-category" required
                            ...
                            <div class="form-row">
                                <div class="col-md-1">
                                    <p class="mb-1 font-weight-bold"><label
                                                for="supplier"><strong>{{ __('Safety Stock') }}</strong></label> {!! $errors->has('buffer_inventory')? '<span class="text-danger text-capitalize">'. $errors->first('buffer_inventory').'</span>':'' !!}
                                    </p>
                                    <div class="select-search-group input-group input-group-md mb-3 d-">
                                        <input type="number" name="buffer_inventory" id="bufferInventory"
                                               class="form-control rounded" aria-label="Large"
                                               placeholder="{{__('Safety Stock Limit')}}"
                                               aria-describedby="inputGroup-sizing-sm"
                                               value="{{ old('buffer_inventory') }}"
                                ...
                                <div class="col-md-1">
                                    <p class="mb-1 font-weight-bold"><label
                                                for="product_unit_id"><strong>{{ __('UOM') }}<span class="text-danger">&nbsp;*</span></strong></label>
                                ...
                                <div class="col-md-3 row">
                                    <div class="col-md-6">
                                        <p class="mb-1 font-weight-bold"><label
                                                    for="unit_price"><strong>{{ __('Unit Price') }}<span
                                                            class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('unit_price')? '<span class="text-danger text-capitalize">'. $errors->first('unit_price').'</span>':'' !!}
                                        </p>
                                        <div class="input-group input-group-md mb-3 d-">
                                            <input type="text" name="unit_price" id="unit_price"
                                                   class="form-control rounded mask-money" step="any" aria-label="Large"
                                                   placeholder="{{__('Item unit price')}}"
                                                   aria-describedby="inputGroup-sizing-sm" required
                                    ...
                                    <div class="col-md-6">
                                        <p class="mb-1 font-weight-bold"><label
                                                    for="sales_price"><strong>{{ __('Sales Price') }}<span
                                                            class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('sales_price')? '<span class="text-danger text-capitalize">'. $errors->first('sales_price').'</span>':'' !!}
                                        </p>
                                        <div class="input-group input-group-md mb-3 d-">
                                ...
                                <div class="col-md-4 row">
                                    <div class="col-md-4">
                                        <p class="mb-1 font-weight-bold"><label for="tax"><strong>{{ __('TAX') }}<span
                                                            class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('tax')? '<span class="text-danger text-capitalize">'. $errors->first('tax').'</span>':'' !!}
                                        </p>
                                        <div class="input-group input-group-md mb-3 d-">
                                            <input type="text" name="tax" step="any" id="tax"
                                                   class="form-control rounded mask-money" aria-label="Large"
                                                   placeholder="{{__('Item tax(%)')}}"
                                                   aria-describedby="inputGroup-sizing-sm" required
                                                   value="{{ old('tax') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="select-search-group  input-group input-group-md mb-3 d-">
                                            {!! Form::Select('vat_type',['exclusive'=>'Exclusive','inclusive'=>'Inclusive'],old('vat_type'),['id'=>'vat_type', 'class'=>'form-control select2']) !!}
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <p class="mb-1 font-weight-bold"><label for="vat"><strong>{{ __('VAT') }}<span
                                                            class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('vat')? '<span class="text-danger text-capitalize">'. $errors->first('vat').'</span>':'' !!}
                                        </p>
                                        <div class="input-group input-group-md mb-3 d-">
                                            <input type="text" name="vat" step="any" id="vat"
                                                   class="form-control rounded mask-money" aria-label="Large"
                                                   placeholder="{{__('Item VAT(%)')}}"
                                                   aria-describedby="inputGroup-sizing-sm" required
                                                   value="{{ old('vat') }}">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group input-group-md mb-3 d-">
                                        <select name="productAttributes[]" id="attributes"
                                                class="form-control rounded product-attributes" multiple
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        @if(isset($attributes[0]))
                                            @foreach($attributes as $key => $attribute)
                                                <div class="col-md-2 mb-3 attributes attribute-{{ $attribute->id }}"
                                                     style="display: none">
                                ...
                                <div class="col-md-12 ledgers-div asset-div" style="display: none">
                                    <p class="mb-1 font-weight-bold"><label for="parent_id">{{ __('Main Asset') }}
                                            :</label> {!! $errors->has('parent_id')? '<span class="text-danger text-capitalize">'. $errors->first('parent_id').'</span>':'' !!}
                                    </p>
                                    <div class="select-search-group input-group input-group-md mb-3 d-">
                                        <select name="parent_id" id="parent_id" class="form-control rounded select2"
                                                required onchange="getSubAssetCode()">
                                ...
                                <div class="col-md-12">
                                    <p class="mb-1 font-weight-bold"><label for="supplier">{{ __('Supplier') }}
                                            :</label> {!! $errors->has('supplier')? '<span class="text-danger text-capitalize">'. $errors->first('supplier').'</span>':'' !!}
                                    </p>
                                    <div class="select-search-group input-group input-group-md mb-3 d-">
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="row pr-3">
                                        <div class="col-md-4 ledgers-div inventory-div">
                                            <label for="inventory_account_id"><strong><span id="inventory-title">Inventory Accounts</span>:<span
                                                            class="text-danger">&nbsp;*</span></strong></label>
                                            <div class="input-group input-group-md mb-3 d-">
                                                <select name="inventory_account_id" id="inventory_account_id"
                                                        class="form-control select-me rounded">
                                                    {!! $accounts !!}
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 ledgers-div consumption-div">
                                            <label for="cogs_account_id"><strong>{{ __('Consumption Account') }}:<span
                                                            class="text-danger">&nbsp;*</span></strong></label>
                                            <div class="input-group input-group-md mb-3 d-">
                                        ...
                                        <div class="col-md-4 ledgers-div sales-div">
                                            <label for="sales_account_id"><strong>{{ __('Sales Account') }}:<span
                                                            class="text-danger">&nbsp;*</span></strong></label>
                                            <div class="input-group input-group-md mb-3 d-">
                                        ...
                                        <div class="col-md-4 ledgers-div asset-div">
                                            <label for="cwip_asset_account_id"><strong>{{ __('Asset Account') }}:<span
                                                            class="text-danger">&nbsp;*</span></strong></label>
                                            <div class="input-group input-group-md mb-3 d-">
                                                <select name="cwip_asset_account_id" id="cwip_asset_account_id"
                                                        class="form-control select-me rounded">
                                                    {!! $accounts !!}
                                                </select>
                                            </div>
                                ...
                                <div class="col-md-12 mb-4 mt-4 fixed-asset-info" style="display: none">
                                    <div class="card">
                                        <div class="card-body bordered">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <label for="depreciation_method_id"><strong>Depreciation
                                                            Method</strong></label>
                                                    <select name="depreciation_method_id" id="depreciation_method_id"
                                                            class="form-control rounded"
                                                            onchange="getDepreciationMethodOptions()">
                                                        @if(isset($depreciationMethods[0]))
                                                            @foreach($depreciationMethods as $key => $depreciationMethod)
                                                                <option value="{{ $depreciationMethod->id }}"
                                                                        data-code="{{ $depreciationMethod->code }}"
                                                                        data-base-rate="{{ $depreciationMethod->base_rate }}"
                                                                        data-depreciation-rate="{{ $depreciationMethod->depreciation_rate }}">{{ $depreciationMethod->code }}
                                                                    - {{ $depreciationMethod->name}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                                <div class="col-md-10">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="depreciation_cost_account_id"><strong>{{ __('Depreciation Account') }}
                                                                    :<span class="text-danger">&nbsp;*</span></strong></label>
                                                            <div class="input-group input-group-md mb-3 d-">
                                                                <select name="depreciation_cost_account_id"
                                                                        id="depreciation_cost_account_id"
                                                                        class="form-control rounded">
                                                                    {!! $accounts !!}
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="inventory_adjustments_account_id"><strong>Accumulated
                                                                    Depreciation Account:<span class="text-danger">&nbsp;*</span></strong></label>
                                                            <div class="input-group input-group-md mb-3 d-">
                                                                <select name="inventory_adjustments_account_id"
                                                                        id="inventory_adjustments_account_id"
                                                                        class="form-control select-me rounded">
                                                                    {!! $accounts !!}
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="depreciation_disposal_account_id"><strong>{{ __('Disposal Account') }}
                                                                    :<span class="text-danger">&nbsp;*</span></strong></label>
                                                            <div class="input-group input-group-md mb-3 d-">
                                                                <select name="depreciation_disposal_account_id"
                                                                        id="depreciation_disposal_account_id"
                                                                        class="form-control rounded">
                                                                    {!! $accounts !!}
                                                                </select>
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2 method-options base_rate" style="display: none">
                                                    ...
                                                    <input type="text" name="base_rate" id="base_rate" value="0.00"
                                                           step="0.01" class="form-control mask-money">
                                                </div>

                                                <div class="col-md-2 method-options years" style="display: none">
                                                    <label for="years"><strong>Depreciation Years:</strong></label>
                                                    <input type="number" name="years" id="years" value="20"
                                                           class="form-control" class="form-control"
                                                           onchange="calculateDepreciationPercentage()"
                                                           onkeyup="calculateDepreciationPercentage()"
                                                           oninput="this.value = Math.abs(this.value)">
                                                </div>
                                                <div class="col-md-2 method-options depreciation_rate"
                                                     style="display: none">
                                                    <label for="depreciation_rate"><strong>Depreciation Rate
                                                            (%)</strong></label>
                                                    <input type="text" name="depreciation_rate" id="depreciation_rate"
                                                           value="0.00" step="0.0001" class="form-control mask-money">
                                                </div>
                                                <div class="col-md-2 method-options rate_multiplier"
                                                     style="display: none">
                                                    <label for="rate_multiplier"><strong>Rate
                                                            Multiplier:</strong></label>
                                                    <input type="text" name="rate_multiplier" id="rate_multiplier"
                                                           value="0.00" step="0.01" class="form-control mask-money">
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="is_final_asset"><strong>{{ __('Final Asset ? ') }}:<span
                                                                    class="text-danger">&nbsp;*</span></strong></label>
                                                    <div class="input-group input-group-md mb-3 d-">
                                                        <select name="is_final_asset" id="is_final_asset"
                                                                class="form-control rounded">
                            ...
                            <div class="col-md-12 pb-5">
                                <a class="btn btn-danger rounded pull-right ml-2"
                                   href="{{ url('pms/product-management/product') }}"><i
                                            class="la la-times"></i>&nbsp;{{ __('Close') }}</a>
                                <button type="button" class="btn btn-success rounded pull-right ml-2 save-button"
                                        onclick="saveProduct('save')"><i class="fa fa-check"></i>&nbsp;Save Item
                                </button>

                                <button type="button" class="btn btn-info rounded pull-right save-and-new-button"
                                        onclick="saveProduct('save-and-new')"><i class="fa fa-check"></i>&nbsp;Save &
                                    New Item
                                </button>
                            </div>
                        </form>
...
@section('page-script')
    <script type="text/javascript">
        ...
        function getSubCategories() {
            $.ajax({
                url: "{{ url('pms/product-management/product/create') }}?get-sub-categories&" + $('#product_type').val(),
                type: 'GET',
                data: {},
            })
                .done(function (response) {
                    $('#category_id').html('<option selected disabled value="">Choose Sub Category</option>' + response).change();
                });
        }
    </script>
@endsection