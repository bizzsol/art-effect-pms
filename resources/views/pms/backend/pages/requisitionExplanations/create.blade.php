			...
			<div class="">
				<div class="panel panel-info">
					<div class="panel-body">
						<form action="{{ route('pms.requisition-explanations.store') }}" method="post">
						@csrf
							<div class="row">
								<div class="col-md-12">
									...
									<div class="select-search-group input-group input-group-md mb-3 d-">
										<input type="text" name="explanation" id="explanation" value="{{ old('explanation') }}" placeholder="Write your explanation..." class="form-control">
									</div>
								</div>

								<div class="col-md-12">
									<a class="btn btn-danger rounded pull-right" href="{{ url('pms/requisition-explanations') }}"><i class="la la-times"></i>&nbsp;{{ __('Close') }}</a>
									<button type="submit" class="btn btn-success rounded pull-right mr-3"><i class="la la-save"></i>&nbsp;Save Explanation</button>
								</div>
							</div>
						</form>
					</div>
