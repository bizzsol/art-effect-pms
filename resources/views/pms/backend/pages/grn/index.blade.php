                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-6">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="date" name="from_date" id="from_date" class="form-control rounded"
                            ...
                            <div class="col-md-2 col-sm-6">
                                ...
                                <div class="input-group input-group-md mb-3 d-">
                                    <input type="date" name="to_date" id="to_date" class="form-control rounded"
                                           aria-label="Large" aria-describedby="inputGroup-sizing-sm"
                                           value="{{ $to_date }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-6">
                                <p class="mb-1 font-weight-bold"><label
                                            for="received_status">{{ __('Received Status') }}:</label></p>
                                <div class="input-group input-group-md mb-3 d-">
                                    <select name="received_status" id="received_status" class="form-control rounded">
                                        <option value="">{{ __('Select One') }}</option>
                                        <option value="full" {{ $received_status == "full" ? 'selected' : '' }}>Full
                                            Received
                                        </option>
                                        <option value="partial" {{ $received_status == "partial" ? 'selected' : '' }}>
                                            Partial Received
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-2 col-sm-6">
                                ...
                                <div class="input-group input-group-md">
                                    ...
                                    &nbsp;&nbsp;
                                    <a class="btn btn-danger rounded mt-8" href="{{ url('pms/grn/grn-process') }}"><i
                                                class="las la-times"></i>&nbsp;Clear</a>
                                </div>
                            </div>
                        </div>
                    </form>
