    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div style="width: 100%;float: left;clear: right;margin-bottom: 25px;">
                        ...
                        <tbody>
                            <tr>
                                <td style="border: 1px solid #ccc">
                                    <table class="table-no-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 75%">
                                                    {{isset($grn->relPurchaseOrder->relQuotation->relSuppliers->name)?$grn->relPurchaseOrder->relQuotation->relSuppliers->name:''}}
                                                    &nbsp;&nbsp;|&nbsp;&nbsp;
                                                    {{isset($grn->relPurchaseOrder->relQuotation->relSuppliers->email)?$grn->relPurchaseOrder->relQuotation->relSuppliers->email:''}}
                                                    &nbsp;&nbsp;|&nbsp;&nbsp;
                                                    {{isset($grn->relPurchaseOrder->relQuotation->relSuppliers->phone)?$grn->relPurchaseOrder->relQuotation->relSuppliers->phone:''}}
                                                    &nbsp;&nbsp;|&nbsp;&nbsp;
                                                    {{isset($grn->relPurchaseOrder->relQuotation->relSuppliers->address)?$grn->relPurchaseOrder->relQuotation->relSuppliers->address:''}}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <table class="table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><strong>{{ number_format($grn->relGoodsReceivedItems->sum('qty'), 0) }}</strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <br>
                                    <center>
                                        {!! printBarcode($purchaseOrder->reference_no) !!}
                                    </center>
                                </td>
                            </tr>
                        </tbody>
