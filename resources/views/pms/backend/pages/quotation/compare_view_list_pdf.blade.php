                                                        ...
                                                        <div class="col-md-6 well">
                                                            <ul class="list-unstyled mb0">
                                                                ...
                                                                @if($requisitionItems->isNotEmpty())
                                                                    <li><strong>Requisition Ref Number :</strong> {{$requisitionItems->first()->requisition->reference_no }}
                                                                    </li>
                                                                @endif
                                                                <li>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                @if(isset($quotations->first()->relRequestProposal->approvals[0]))
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%"
                                                            class="text-center">{{ date('Y-m-d g:i a', strtotime($quotations->first()->relRequestProposal->approvals->first()->created_at)) }}</td>
                                                    </tr>
                                                    @foreach($quotations->first()->relRequestProposal->approvals as $key => $approval)
                                                        <tr>
                                                            <td style="width: 10%"
                                                                class="text-center">{{ $approval->priority }}</td>
                                                            <td style="width: 55%">{{ $approval->user->name }}</td>
                                                            <td style="width: 15%"
                                                                class="text-center">{{ ucwords($approval->response) }}</td>
                                                            <td style="width: 20%"
                                                                class="text-center">{{ date('Y-m-d g:i a', strtotime($approval->updated_at)) }}</td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                                </tbody>
