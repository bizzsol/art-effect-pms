    ...
    <div class="iq-card">
        <div class="iq-card-header d-flex justify-content-between p-0 bg-white">
            <div class="iq-header-title">
                <h4 class="card-title text-primary border-left-heading">AUDIT MANAGEMENT STATS</h4>
            </div>
        </div>
        <div class="iq-card-body p-0">
            <div class="hr-section">
                <!-- Billing Attachments Section -->
                <section id="audit-billing-attachment" class="p-3 border-bottom">
                ...
                <!-- PO Advance Section -->
                <section id="audit-po-advance" class="p-3 border-bottom">
                    <h6 class="mb-3 text-secondary font-weight-bold">
                ...
                <section id="audit-spot-purchase" class="p-3">
                    <h6 class="mb-3 text-secondary font-weight-bold">
