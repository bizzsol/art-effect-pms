    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="panel panel-info">
                <form action="{{ url('pms/rfp/re-assess-requisitions/'.$requisition->id) }}" method="POST"
                    id="editRequisitionForm" enctype="multipart/form-data" class="formInputValidation">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                                ...
                                <table class="table table-striped table-bordered miw-500 dac_table"
                                    ...
                                    <tbody class="field_wrapper">
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-attributes product-attributes-{{ $key+1 }}"
                                                data-serial="{{ $key+1 }}"
                                            ...
                                            <td class="text-right"><input type="number" name="qty[{{ $item->id }}]" class="form-control" value="{{ $item->qty }}" step="0.01">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="reassess_note" id="reassess_note"
                                        class="form-control">{{ old('reassess_note', $requisition->reassess_note ?? '') }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary rounded" style="float: right"><i
                                        class="la la-plus"></i> Send for Re-Assessment
                                </button>
                            </div>
                        </div>
                    </div>
