                    ...
                    <div id="accordion">
                        <div class="card">
                            ...
                            <div id="filter" class="collapse {{ !request()->has('from') ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    <form action="{{ route('pms.rfp.rejected-requisitions') }}" method="get"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 pt-1 mt-4 ml-auto text-right">
                                                <button class="btn btn-sm btn-success report-button" type="submit">
                                                    <i class="la la-search"></i>&nbsp;Search
                                                </button>

                                                <a class="btn btn-sm btn-danger"
                                                    href="{{ route('pms.rfp.rejected-requisitions') }}">
...
<script>
    ...
    function undoReject(element) {
        $.confirm({
            title: 'Restore Requisition',
            content: 'Are you sure you want to restore this requisition?',
            buttons: {
                restore: {
                    text: 'Restore',
                    btnClass: 'btn-blue',
