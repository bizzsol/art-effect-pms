                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        {!! Form::label('department_id', 'Choose Department', array('class' => 'mb-1 font-weight-bold')) !!} <strong></strong>
                                        <select name="department_id" id="department_id" class="form-control rounded select2" onchange="getProducts()">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {!! Form::label('product_id', 'Choose Product', array('class' => 'mb-1 font-weight-bold')) !!} <strong></strong>
                                        <select name="product_id" id="product_id" class="form-control rounded select2">
                            ...
                            <div class="col-md-2">
                                <div class="form-group pt-4">
                                    <button type="button" class="btn btn-success btn-md mt-1 btn-block" onclick="search()"><i class="la la-search"></i>&nbsp;Filter</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-right pt-2">
                                    <label class="btn btn-xs rounded font-5 mt-10 pull-right ">
                                        <input type="checkbox" name="type" class="" value='online'> Allow Online
                                        Quotation
                                    </label>
                                </div>
                                <div class="col-md-3">
                                    <button data-placement="top" data-content="click save changes button for send rfp"
                                            type="submit"
                                            class="btn-block btn btn-success rounded font-10 mt-10 submit-button"><i
