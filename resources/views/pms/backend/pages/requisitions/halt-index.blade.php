        ...
        <div class="">
            <div class="panel panel-info">
              ...
              <div id="filter" class="collapse {{ !request()->has('from') ? 'show' : '' }}" aria-labelledby="headingOne" data-parent="#accordion">
                  <div class="card-body">
                    <form action="{{ url('pms/requisition/halt-requisition') }}" method="get" accept-charset="utf-8">
                        <div class="row">
                            <div class="col-md-2">
                        ...
                        <div class="col-md-1 pt-1 pl-0 mt-4">
                            <a class="btn btn-sm btn-block btn-danger" href="{{ url('pms/requisition/halt-requisition') }}"><i class="la la-times"></i>&nbsp;Clear</a>
                        </div>
