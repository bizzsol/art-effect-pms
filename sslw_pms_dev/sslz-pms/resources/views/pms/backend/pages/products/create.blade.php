                ...
                <div class="panel-boby p-3">
                        ...
                        <input type="hidden" name="where_to_go" id="where_to_go" value="save">
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <p class="mb-1 font-weight-bold"><label for="category_id"><strong>Sub Category<span class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('category_id')? '<span class="text-danger text-capitalize">'. $errors->first('category_id').'</span>':'' !!}</p>
                                ...
                                <div class="col-md-1">
                                    ...
                                    <div class="col-md-3 row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-md mb-3 d-">
                                                <input type="text" name="sales_price" id="sales_price" class="form-control rounded mask-money" step="any" aria-label="Large" placeholder="{{__('Item unit price')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('sales_price') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 row">
                                        <div class="col-md-6">
                                            <p class="mb-1 font-weight-bold"><label for="tax"><strong>{{ __('TAX') }}<span class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('tax')? '<span class="text-danger text-capitalize">'. $errors->first('tax').'</span>':'' !!}</p>
                                            <div class="input-group input-group-md mb-3 d-">
                                                <input type="text" name="tax" step="any" id="tax" class="form-control rounded mask-money" aria-label="Large" placeholder="{{__('Item tax(%)')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('tax') }}" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <p class="mb-1 font-weight-bold"><label for="vat"><strong>{{ __('VAT') }}<span class="text-danger">&nbsp;*</span></strong></label> {!! $errors->has('vat')? '<span class="text-danger text-capitalize">'. $errors->first('vat').'</span>':'' !!}</p>
                                            <div class="input-group input-group-md mb-3 d-">
                                                <input type="text" name="vat" step="any" id="vat" class="form-control rounded mask-money" aria-label="Large" placeholder="{{__('Item VAT(%)')}}" aria-describedby="inputGroup-sizing-sm" required value="{{ old('vat') }}" >
                                            </div>
                                        </div>
                                    </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="row pr-3">
                                        ...
                                        <div class="col-md-4 ledgers-div sales-div">
                                            ...
                                            <div class="input-group input-group-md mb-3 d-">
                                                <select name="sales_account_id" id="sales_account_id" class="form-control select-me rounded">
                                                    {!! $accounts !!}
                                                </select>
                                            </div>
                                        </div>
