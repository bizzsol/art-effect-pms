						...
						<form action="{{ route('pms.product-management.sub-category.update', $category->id) }}
							...
							<div class="row">
								...
								<div class="col-md-2">
			                        ...
			                        <div class="select-search-group input-group input-group-md mb-3 d-" onchange="getCategories()">
			                            ...
			                            <div class="card-body bordered">
			                                ...
			                                <div class="row">
			                                    <div class="col-md-2">
			                                        ...
			                                        <input type="number" name="depreciation_rate" id="depreciation_rate" value="{{ $category->depreciation_rate }}" step="0.01" class="form-control">
			                                    </div>
			                                    <div class="col-md-10">
			                                        <div class="row">
			                                            <div class="col-md-4">
...
<script>
    ...
    function getCategories(){
        $.ajax({
            url: "{{ url('pms/product-management/sub-category/create') }}?get-categories&product_type="+$('#product_type').val()+"&selected={{ $category->category ? $category->category->id : 0 }}",
            type: 'GET',
            data: {},
        })
        .done(function(response) {
            $('#parent').html(response).change();
        });
    }
</script>
@endsection