											...
											<table class="table table-bordered">
												...
												<tbody>
													...
													<tr id="removeApprovedRow{{$item->id}}">
														...
														<td>{{isset($item->relGoodsReceivedItems->relProduct->name)?$item->relGoodsReceivedItems->relProduct->name:''}} ({{isset($item->relGoodsReceivedItems->relProduct->sku)?$item->relGoodsReceivedItems->relProduct->sku:''}}) {{ getProductAttributes($item->relGoodsReceivedItems->relProduct->id) }}</td>
														...
														<td class="text-right">{{systemDoubleValue($item->unit_amount,2)}}</td>
														<td class="text-center">{{systemDoubleValue($item->relGoodsReceivedItems->qty,0)}}</td>
														<td class="text-center">{{$item->received_qty}}</td>
														<td class="text-center">{{$item->relGoodsReceivedItems->qty-$item->received_qty}}</td>
														<td class="text-right">{{systemDoubleValue($item->unit_amount*$item->received_qty,2)}}</td>
													</tr>
													@endforeach
													<tr>
														<td colspan="3" class="text-right">Total</td>
														<td colspan="" class="text-right">{{isset($approved)?systemDoubleValue($approved->sum('unit_amount'),2):0}}</td>
														...
														<td class="text-right">{{isset($approved)?systemDoubleValue($sumOfSubtotal,4):0}}</td>
													</tr>
