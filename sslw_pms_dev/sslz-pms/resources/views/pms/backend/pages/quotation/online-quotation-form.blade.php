            ...
            <table class="table table-striped table-bordered table-head" cellspacing="0" width="100%" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="unit_price[{{$item->product->id}}]" required class="form-control" min="0.0" step="0.01"  id="unit_price_{{$item->product->id}}" placeholder="0.00" onkeyup="calculateSubtotal({{$item->product->id}})">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><input type="number" name="gross_price" readonly class="form-control" id="grossPrice" placeholder="0.00"></td>
                        <td></td>
                    </tr>
                </tbody>
            </table>
